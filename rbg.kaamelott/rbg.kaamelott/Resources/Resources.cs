...
namespace rbg.kaamelott.Resources
{
    public class Resources
    {
        public static Stream GetSampleStreamFromResources(string filename)
        {
            ...
            try
            {
                stream = assembly.GetManifestResourceStream(
                    "rbg.kaamelott.Resources.Samples." + filename);
            }
            catch { }
            return stream;
        }
        ...
        public static string GetJSONFromResources(string filename)
        {
            ...
            try
            {
                var stream = assembly.GetManifestResourceStream("rbg.kaamelott.Resources." + filename);
