...
namespace rbg.kaamelott.Converters
{
    public class StringToImageConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            var realNameImage = "rbg.kaamelott.Resources.Images." + imageName;
            if (HasResource(realNameImage))
            {
                var img = ImageSource.FromResource(realNameImage);
                return img;
            }
            return ImageSource.FromResource("rbg.kaamelott.Resources.Images.profile_generic.png");
        }
